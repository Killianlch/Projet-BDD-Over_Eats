...
CREATE TABLE Allergenes (
  ...
  CONSTRAINT fk_Allergenes_Element_Menu1
    ...
    REFERENCES Element_Menu (ID_Element)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
);
...
CREATE TABLE Promotion (
  ...
  INDEX fk_Promotion_Menu1_idx (Menu_ID_Menu ASC) VISIBLE,
...
CREATE TABLE Media (
  ...
  INDEX fk_Media_Restaurant1_idx (Restaurant_ID_Restaurant ASC) VISIBLE,
...
CREATE TABLE Clients (
  ...
  INDEX fk_Clients_Adresse1_idx (Adresse_ID_Adresse ASC) VISIBLE,
...
CREATE TABLE Commandes (
  ...
  INDEX fk_Commandes_Restaurant1_idx (Restaurant_ID_Restaurant ASC) VISIBLE,
  INDEX fk_Commandes_adresse1_idx (Adresse_ID_Adresse ASC) VISIBLE,
  INDEX fk_Commandes_Facture1_idx (Facture_id_Facture ASC) VISIBLE,
  INDEX fk_Commandes_Clients1_idx (Clients_ID_Client ASC) VISIBLE,
  INDEX fk_Commandes_Coursiers1_idx (Coursiers_ID_Coursier ASC) VISIBLE,
  INDEX fk_Commandes_statut_commande1_idx (Statut_Commande_ID_Statut_Commande ASC) VISIBLE,
  ...
  CONSTRAINT fk_Commandes_Coursiers1
    ...
    REFERENCES Coursiers (ID_Coursier)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE Pieces_Identite (
  ...
  INDEX fk_Pieces_identite_Coursiers1_idx (Coursiers_ID_Coursier ASC) VISIBLE,
...
CREATE TABLE  Menu_Commande (
  ...
  INDEX fk_Menu_has_Commandes_Commandes1_idx (Commandes_ID_Commande ASC) VISIBLE,
  INDEX fk_Menu_has_Commandes_Menu1_idx (Menu_ID_Menu ASC) VISIBLE,
